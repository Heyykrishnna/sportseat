...
function Hero() {
  ...
  return (
    <section id="top" className="relative min-h-[640px] overflow-hidden bg-[#6fb1d2] text-white md:min-h-screen">
      <img
      ...
      <div className="relative z-20 flex min-h-[640px] items-end px-5 pt-32 sm:px-8 md:min-h-[860px] lg:px-12 pb-10">
